...
*   Name of the person to which the resume belongs to.
*   Eg: Name : ABHIJIT GHOSH

1.  Other person’s name should ideally not be annotated
2.  Also, many institutes have their names named after a person. They should also not be annotated either
3.  No other annotation with name like designation or organization. Label only Personal labels

  

### 2) Email-ID

*   Email-id of the person to which the resume belongs to.
*   Eg: abhijitghosh@gmail.com
